...
QString HDTSummaryGenerator::getSummary(HDTController *hdtController)
{
    ...
    output.append(QString(tr("<b>Number of entries</b>: %1<br/>")).arg(loc.toString((uint64_t)dict->getNumberOfElements())));
    ...
    output.append(QString(tr("<b>Number of triples</b>: %1<br/>")).arg(loc.toString((uint64_t)triples->getNumberOfElements())));
